...
CLOUD_MIPS      = 8000      # Cloud has 4x compute
EC_THRESHOLD    = 1.0       # Task sends to cloud if > 1 second
BANDWIDTH_MBPS  = 100       # IoT to fog bandwidth
FOG_CLOUD_BW    = 1000      # Backbone link
FOG_FOG_BW      = 100       # Inter-fog WiFi
WAN_LATENCY_MS  = 30        # Cloud round-trip
G5_LATENCY_MS   = 2         # Vehicle to fog
...
FOG_COVERAGE_RADIUS = 250   # Coverage radius in meters
Q_MAX = 50                  # Queue limit before triggering cloud offload

# Vehicle mobility settings
N_VEHICLES         = 50     # Vehicles in simulation
VEHICLE_SPEED_MEAN = 60     # Average speed km/h
VEHICLE_SPEED_STD  = 15     # Speed variation
TASK_RATE_HZ       = 10     # Camera frame rate
...
TOTAL_DEADLINE_MS = 200     # End-to-end requirement

# Optimization parameters
NSGA_POP_SIZE   = 50        # Population size
NSGA_GENS       = 50        # Generations
MMDE_F          = 0.5       # Mutation scaling
MMDE_CR         = 0.9       # Crossover probability
NSGA_BATCH_SIZE = 100       # Tasks per batch
N_OFFLINE_BATCHES = 1000    # Historical data for training
